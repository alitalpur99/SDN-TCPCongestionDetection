...
def _handle_flowstats_received (event):
  ...
  # I have added: Save stats to a text file (output_file)
  web_bytes = 0
  web_flows = 0
  web_packet = 0
  output_file=open("output.txt", "a+") #my own: open a text(canbeanyotherformat) file and append the stats in it
  ...
  output_file.close() #my own: to close the file
