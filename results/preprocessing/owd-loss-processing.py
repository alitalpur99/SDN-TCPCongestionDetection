...
indexes = peakutils.indexes(delay, thres=0.95, min_dist=1000)
...
""" Diff of the windows: Taking peaks that have larger gap in between"""

diff= [j-i for i, j in zip(indexes[:-1], indexes[1:])]
print "differences between indexed values: \n",diff
for i in range(len(diff)):
	##From graph check how mucbh the gap (diff) value should be
	if values[i]>=0.04 and diff[i]>=1000:
		# print indexes[i+1]
...
# ind11=win_index[0]-300
# ind12=win_index[0]-150
# ind13=win_index[0]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind31=win_index[2]-300
# ind32=win_index[2]-150
# ind33=win_index[2]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind41=win_index[3]-300
# ind42=win_index[3]-150
# ind43=win_index[3]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind51=win_index[4]-300
# ind52=win_index[4]-150
# ind53=win_index[4]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind61=win_index[5]-300
# ind62=win_index[5]-150
# ind63=win_index[5]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind71=win_index[6]-300
# ind72=win_index[6]-150
# ind73=win_index[6]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind81=win_index[7]-300
# ind82=win_index[7]-150
# ind83=win_index[7]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind91=win_index[8]-300
# ind92=win_index[8]-150
# ind93=win_index[8]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind101=win_index[9]-300
# ind102=win_index[9]-150
# ind103=win_index[9]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind111=win_index[10]-300
# ind112=win_index[10]-150
# ind113=win_index[10]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind121=win_index[11]-300
# ind122=win_index[11]-150
# ind123=win_index[11]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind131=win_index[12]-300
# ind132=win_index[12]-150
# ind133=win_index[12]

# print "\n index number for loss 13", ind131, ind132, ind133
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind141=win_index[13]-300
# ind142=win_index[13]-150
# ind143=win_index[13]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind151=win_index[14]-300
# ind152=win_index[14]-150
# ind153=win_index[14]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind161=win_index[15]-300
# ind162=win_index[15]-150
# ind163=win_index[15]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind171=win_index[16]-300
# ind172=win_index[16]-150
# ind173=win_index[16]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind181=win_index[17]-300
# ind182=win_index[17]-150
# ind183=win_index[17]

# print "\n index number for loss 18", ind181, ind182, ind183
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind191=win_index[18]-300
# ind192=win_index[18]-150
# ind193=win_index[18]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind201=win_index[19]-300
# ind202=win_index[19]-150
# ind203=win_index[19]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind211=win_index[20]-300
# ind212=win_index[20]-150
# ind213=win_index[20]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind221=win_index[21]-300
# ind222=win_index[21]-150
# ind223=win_index[21]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind231=win_index[22]-300
# ind232=win_index[22]-150
# ind233=win_index[22]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind241=win_index[23]-300
# ind242=win_index[23]-150
# ind243=win_index[23]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind251=win_index[24]-300
# ind252=win_index[24]-150
# ind253=win_index[24]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind261=win_index[25]-300
# ind262=win_index[25]-150
# ind263=win_index[25]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind271=win_index[26]-300
# ind272=win_index[26]-150
# ind273=win_index[26]
...
# """SECOND VALUE OF WIN INDEX, AND TAKE ONLY 150 IN EACH WINDOW 1,2,3"""
# ind281=win_index[27]-300
# ind282=win_index[27]-150
# ind283=win_index[27]
...
# open("owd-loss-results","w").close()
# with open("owd-loss-results","w") as f:
...
# 		# str(a25)+","+str(a26)+","+str(a27)+","+str(a28)+","+str(a29)+","+str(a30)+","+str(a31)+","+"c"+"\n"
...
# 		# str(b25)+","+str(b26)+","+str(b27)+","+str(b28)+","+str(b29)+","+str(b30)+","+str(b31)+","+"c""\n"
...
# 		# str(c25)+","+str(c26)+","+str(c27)+","+str(c28)+","+str(c29)+","+str(c30)+","+str(c31)+","+"c""\n"
...
# 		# str(d25)+","+str(d26)+","+str(d27)+","+str(d28)+","+str(d29)+","+str(d30)+","+str(d31)+","+"c""\n"
...
# 		# str(e25)+","+str(e26)+","+str(e27)+","+str(e28)+","+str(e29)+","+str(e30)+","+str(e31)+","+"c""\n"
...
# 		# str(f25)+","+str(f26)+","+str(f27)+","+str(f28)+","+str(f29)+","+str(f30)+","+str(f31)+","+"c""\n"
...
# 		# str(g25)+","+str(g26)+","+str(g27)+","+str(g28)+","+str(g29)+","+str(g30)+","+str(g31)+","+"c""\n"
...
# 		# str(h25)+","+str(h26)+","+str(h27)+","+str(h28)+","+str(h29)+","+str(h30)+","+str(h31)+","+"c""\n"
...
# 		# str(i25)+","+str(i26)+","+str(i27)+","+str(i28)+","+str(i29)+","+str(i30)+","+str(i31)+","+"c""\n"
...
# 		# str(j25)+","+str(j26)+","+str(j27)+","+str(j28)+","+str(j29)+","+str(j30)+","+str(j31)+","+"c""\n"
...
# 		# str(k25)+","+str(k26)+","+str(k27)+","+str(k28)+","+str(k29)+","+str(k30)+","+str(k31)+","+"c""\n"
...
# 		# str(l25)+","+str(l26)+","+str(l27)+","+str(l28)+","+str(l29)+","+str(l30)+","+str(l31)+","+"c""\n"
...
# 		# str(m25)+","+str(m26)+","+str(m27)+","+str(m28)+","+str(m29)+","+str(m30)+","+str(m31)+","+"c""\n"
...
# 		# str(n25)+","+str(n26)+","+str(n27)+","+str(n28)+","+str(n29)+","+str(n30)+","+str(n31)+","+"c""\n"
...
# 		# str(o25)+","+str(o26)+","+str(o27)+","+str(o28)+","+str(o29)+","+str(o30)+","+str(o31)+","+"c""\n"
...
# 		# str(p25)+","+str(p26)+","+str(p27)+","+str(p28)+","+str(p29)+","+str(p30)+","+str(p31)+","+"c""\n"
...
# 		# str(q25)+","+str(q26)+","+str(q27)+","+str(q28)+","+str(q29)+","+str(q30)+","+str(q31)+","+"c""\n"
...
# 		# str(r25)+","+str(r26)+","+str(r27)+","+str(r28)+","+str(r29)+","+str(r30)+","+str(r31)+","+"c""\n"
...
# 		# str(s25)+","+str(s26)+","+str(s27)+","+str(s28)+","+str(s29)+","+str(s30)+","+str(s31)+","+"c""\n"
# 	f.write(str(t1)+","+str(t2)+","+str(t3)+","+str(t4)+","+str(t5)+","+str(t6)+","+str(t7)+","+str(t8)+","+
...
# 		str(t25)+","+str(t26)+","+str(t27)+","+str(t28)+","+str(t29)+","+str(t30)+","+str(t31)+","+"c""\n"
...
# 		# str(u25)+","+str(u26)+","+str(u27)+","+str(u28)+","+str(u29)+","+str(u30)+","+str(u31)+","+"c""\n"
...
# 		str(v25)+","+str(v26)+","+str(v27)+","+str(v28)+","+str(v29)+","+str(v30)+","+str(v31)+","+"c""\n"
...
# 		# str(w25)+","+str(w26)+","+str(w27)+","+str(w28)+","+str(w29)+","+str(w30)+","+str(w31)+","+"c""\n"
...
# 		# str(x25)+","+str(x26)+","+str(x27)+","+str(x28)+","+str(x29)+","+str(x30)+","+str(x31)+","+"c""\n"
...
# 		# str(y25)+","+str(y26)+","+str(y27)+","+str(y28)+","+str(y29)+","+str(y30)+","+str(y31)+","+"c""\n"
...
# 		# str(z25)+","+str(z26)+","+str(z27)+","+str(z28)+","+str(z29)+","+str(z30)+","+str(z31)+","+"c""\n"
...
# 		# str(aa25)+","+str(aa26)+","+str(aa27)+","+str(aa28)+","+str(aa29)+","+str(aa30)+","+str(aa31)+","+"c""\n"
...
# 		str(ab25)+","+str(ab26)+","+str(ab27)+","+str(ab28)+","+str(ab29)+","+str(ab30)+","+str(ab31)+","+"c""\n"
...
# 		# str(ac25)+","+str(ac26)+","+str(ac27)+","+str(ac28)+","+str(ac29)+","+str(ac30)+","+str(ac31)+","+"c""\n"
...
# 		# str(ad25)+","+str(ad26)+","+str(ad27)+","+str(ad28)+","+str(ad29)+","+str(ad30)+","+str(ad31)+","+"c""\n"
...
# 		# str(ae25)+","+str(ae26)+","+str(ae27)+","+str(ae28)+","+str(ae29)+","+str(ae30)+","+str(ae31)+","+"c""\n"
...
# 		# str(af25)+","+str(af26)+","+str(af27)+","+str(af28)+","+str(af29)+","+str(af30)+","+str(af31)+","+"c""\n"
...
# 		str(ag25)+","+str(ag26)+","+str(ag27)+","+str(ag28)+","+str(ag29)+","+str(ag30)+","+str(ag31)+","+"c""\n"
...
# 		str(ah25)+","+str(ah26)+","+str(ah27)+","+str(ah28)+","+str(ah29)+","+str(ah30)+","+str(ah31)+","+"c""\n"
...
# 		# str(ai25)+","+str(ai26)+","+str(ai27)+","+str(ai28)+","+str(ai29)+","+str(ai30)+","+str(ai31)+","+"c""\n"
...
# 		str(aj25)+","+str(aj26)+","+str(aj27)+","+str(aj28)+","+str(aj29)+","+str(aj30)+","+str(aj31)+","+"c""\n"
...
# 		str(ak25)+","+str(ak26)+","+str(ak27)+","+str(ak28)+","+str(ak29)+","+str(ak30)+","+str(ak31)+","+"c""\n"
...
# 		str(al25)+","+str(al26)+","+str(al27)+","+str(al28)+","+str(al29)+","+str(al30)+","+str(al31)+","+"c""\n")
...
# 		# str(am25)+","+str(am26)+","+str(am27)+","+str(am28)+","+str(am29)+","+str(am30)+","+str(am31)+","+"c""\n"
...
# 		# str(an25)+","+str(an26)+","+str(an27)+","+str(an28)+","+str(an29)+","+str(an30)+","+str(an31)+","+"c""\n"
...
# 		# str(ao25)+","+str(ao26)+","+str(ao27)+","+str(ao28)+","+str(ao29)+","+str(ao30)+","+str(ao31)+","+"c""\n"
...
# 		# str(ap25)+","+str(ap26)+","+str(ap27)+","+str(ap28)+","+str(ap29)+","+str(ap30)+","+str(ap31)+","+"c""\n"
...
# 		# str(aq25)+","+str(aq26)+","+str(aq27)+","+str(aq28)+","+str(aq29)+","+str(aq30)+","+str(aq31)+","+"c""\n"
...
# 		# str(ar25)+","+str(ar26)+","+str(ar27)+","+str(ar28)+","+str(ar29)+","+str(ar30)+","+str(ar31)+","+"c""\n"
...
# 		# str(as25)+","+str(as26)+","+str(as27)+","+str(as28)+","+str(as29)+","+str(as30)+","+str(as31)+","+"c""\n"
...
# 		# str(at25)+","+str(at26)+","+str(at27)+","+str(at28)+","+str(at29)+","+str(at30)+","+str(at31)+","+"c""\n"
...
# 		# str(au25)+","+str(au26)+","+str(au27)+","+str(au28)+","+str(au29)+","+str(au30)+","+str(au31)+","+"c""\n"
...
# 		# str(av25)+","+str(av26)+","+str(av27)+","+str(av28)+","+str(av29)+","+str(av30)+","+str(av31)+","+"c""\n"
...
# 		# str(aw25)+","+str(aw26)+","+str(aw27)+","+str(aw28)+","+str(aw29)+","+str(aw30)+","+str(aw31)+","+"c""\n"
...
# 		# str(ax25)+","+str(ax26)+","+str(ax27)+","+str(ax28)+","+str(ax29)+","+str(ax30)+","+str(ax31)+","+"c""\n"
...
for i in range(len(data1)):
	...
	plt.plot(time1[i] , data1[i],'go', markersize=10)
plt.plot(time1[0],data1[0],'go', markersize=10,label='Selected Loss Peaks')
plt.legend()
plt.title("Single Flow, Queue=Q50, BW=10Mbps, RTT=60ms")
plt.xlabel('Time (sec)')
