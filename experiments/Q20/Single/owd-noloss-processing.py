...
plt.plot(t1,d1,'ko', markersize=10, label='No-loss window points')
plt.plot(t2,d2,'bo', markersize=10)
plt.plot(t3,d3,'ro', markersize=10)
plt.plot(t4,d4,'go', markersize=10)
plt.plot(t5,d5,'yo', markersize=10)
...
plt.plot(t28,d28,'mo', markersize=10, label='No-loss window points')

plt.title("Single Flow, Queue=20, BW=10Mbps, RTT=20ms")
plt.xlabel("Time (sec)")
plt.ylabel("One-way Delay (msec)")
plt.legend()
pyplot.show()
